...
def get_flag(code):
    ...
    country_objects = [CountryFlag(country[0], country[1], country[2]) for country in countries_list]

    return [country for country in country_objects if country.code == code] \
        [0] \
        .flag
